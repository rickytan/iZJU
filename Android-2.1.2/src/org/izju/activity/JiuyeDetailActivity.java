...
public class JiuyeDetailActivity extends StatActivity {
	private final String TAG = "org.izju.activity.JiuyeDetailActivity";
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        DataChangeHandler dataChangeHandler = new DataChangeHandler(){
            final List<HashMap<String, Object>> data = JiuyeDetailActivity.this.data;
