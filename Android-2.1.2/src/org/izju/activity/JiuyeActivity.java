...
public class JiuyeActivity extends StatActivity {
	private final String TAG = "org.izju.activity.JiuyeActivity";
	private final String URL = "http://www.izju.org/data/jiuye.php";
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        titleText.setText(R.string.jiuye);
        
        ListView listView = (ListView) findViewById(R.id.listView_list_1);
        //set content
        
        SimpleAdapter adapter = new SimpleAdapter(this, data, R.layout.jiuye_list_item, 
        		new String[]{"title", "seminar"}, 
        		new int[]{R.id.jiuye_item_title, R.id.jiuye_item_seminar});
        ...
        listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
					long arg3) {
				Intent intent = new Intent(JiuyeActivity.this, JiuyeDetailActivity.class);
        ...
        DataChangeHandler dataChangeHandler = new DataChangeHandler(){
            private final List<HashMap<String, Object>> data = JiuyeActivity.this.data;
			...
			public void changeData(String strData) {
				...
				try{
					...
					for(int i=0; i<len; i++){
						...
						item.put("seminar", jsonItem.getString("seminar"));
						data.add(item);
					}
