...
public class ZhusuActivity extends StatActivity {
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        bgImg.setImageResource(R.drawable.bg_zhusu);
        ...
        listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(ZhusuActivity.this, ZhusuListActivity.class);
				switch(arg2){
				case 0:
					intent.putExtra("path", "zhusu"); break;
				case 1:
					intent.putExtra("path", "rizu"); break;
				}
