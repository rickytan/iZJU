...
public class JiaoliuActivity extends StatActivity {
	private final String TAG = "org.izju.activity.JiaoliuActivity";
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
					long arg3) {
				Intent intent = new Intent(JiaoliuActivity.this, JiaoliuDetailActivity.class);
        ...
        DataChangeHandler dataChangeHandler = new DataChangeHandler(){
            final List<HashMap<String, Object>> data = JiaoliuActivity.this.data;
			@Override
